...
public class GetAppointmentInfo_Group_Primary extends base {
	...
	@Test(priority = 11)
	public void PerAptGroupCannotCancelByGrpMbr() {
		...
		Response res = given()
				.headers("SOAPAction", "http://tempuri.org/IScheduling/GetAppointmentInfo", "Content-Type",
						"text/xml; charset=utf-8")
				.and().body(SchedulingPL.GetAppointmentInfo(companyId, groupMemberId, appointmentId)).when()
				.post("//Visits/Scheduling.svc")
				.then()
				//.log().all()
				.statusCode(200).extract().response();
	...
	@Test(priority = 12)
	public void PerMbrGroupCannotCancelByGrpMbr() {
...
//		String groupMemberId = prop.getProperty("groupMemberId");
	...
	public void membershipTypeRestrictionsMbr() {
		...
		System.out.println("appointmentIdId = " + appointmentId);
